...
def controller(parser, embed_model):
    ...
    #get_model_instance(model_name, embedding_model, learning_rate, gradient_clip=None, batch_norm=None, keep_prob=1.0, label_size=2, n_word=40, n_char=33):
    ...
    #print(type(model))
    print("get model")
    model = md.CharCNN(architecture, load_model="./log/l0.000100_e100_b100/model.ckpt")
    ...
    #target, label ,idx = balanced_validation_split(data["sentence"], data["label"], data["Id"],1)
...
if __name__ == '__main__':
    ...
    parser.add_argument ('--input_file' , type=str , default="./"
                                                             "news_headlines_paraphrases_sentiment.csv" ,
                                                              help=' load path')
